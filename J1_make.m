...
%         dVdb2 = 1*(dVdB(1,2)*(-1* purelin('dn',r(1,2)) ) + dVdB(1,3)*(-1* purelin('dn',r(1,3)) ) + dVdB(2,3)*(-1* purelin('dn',r(2,3)) ));
        ...
        dVdw1 = 1*(dVdA(1,2)*(-1* r(1,2) ) + dVdA(1,3)*(-1* r(1,3) )+dVdA(2,3)*(-1*r(2,3) )); %Multiplied by 2, to take into account A(i,j) as well as A(j,i) terms
        dVdw2 = 1*(dVdB(1,2)*(-1* r(1,2) ) + dVdB(1,3)*(-1* r(1,3) )+dVdB(2,3)*(-1*r(2,3) ));

        dVdb1 = 1*(dVdA(1,2)*(-1 ) + dVdA(1,3)*(-1 ) + dVdA(2,3)*(-1 ));
        dVdb2 = 1*(dVdB(1,2)*(-1 ) + dVdB(1,3)*(-1 ) + dVdB(2,3)*(-1 ));
